...
main. The existing goal_direction vocabulary is retained; missing objective
withholds comparison. objective_ranking now carries ordered option identities,
dense tie ranks and exact model win shares. Contradictory or malformed ranking
states are rejected. Producer and consumer adoption is a coordinated N+1 train,
not a declaration of deployed support. No factor-quantification vocabulary is
added here. Version 0.51.0 remains reserved by the existing receipt PR.
